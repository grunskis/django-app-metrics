...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetricItem.content_type'
        db.add_column('app_metrics_metricitem', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MetricItem.object_id'
        db.add_column('app_metrics_metricitem', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MetricItem.content_type'
        db.delete_column('app_metrics_metricitem', 'content_type_id')

        # Deleting field 'MetricItem.object_id'
        db.delete_column('app_metrics_metricitem', 'object_id')
